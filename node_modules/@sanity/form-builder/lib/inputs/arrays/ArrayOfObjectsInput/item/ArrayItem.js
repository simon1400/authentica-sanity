...
function ArrayItem(props) {
  ...
  var scopedValidation = (0, _react.useMemo)(() => markers.length === 0 ? _empty.EMPTY_ARRAY : markers.filter(_types.isValidationMarker).map(marker => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_changeIndicators.ChangeIndicatorScope, {
    ...
    readOnly: readOnly,
    type: itemType,
    presence: isEditing ? _empty.EMPTY_ARRAY : presence,
