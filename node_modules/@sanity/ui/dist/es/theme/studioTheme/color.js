...
const color = createColorTheme({
  ...
  button: ({base, mode, muted, solid}) => {
    if (mode === "bleed") {
      return __objSpread(__objSpread({}, muted), {
        enabled: __objSpread(__objSpread({}, muted.enabled), {
          bg: base.bg,
          border: base.bg
        }),
        disabled: __objSpread(__objSpread({}, muted.disabled), {
          bg: base.bg,
          border: base.bg
        })
      });
    ...
    if (mode === "ghost") {
      return __objSpread(__objSpread({}, solid), {
        enabled: __objSpread(__objSpread({}, muted.enabled), {bg: base.bg, border: base.border}),
        disabled: __objSpread(__objSpread({}, muted.disabled), {
          bg: base.bg
        })
      });
  ...
  card: ({base, dark, muted, name, state}) => {
    ...
    if (state === "hovered") {
      ...
      return __objSpread(__objSpread({}, muted.hovered), {
    ...
    if (state === "pressed") {
      return __objSpread(__objSpread({}, muted.pressed), {
        fg: base.fg,
        muted: {
    ...
    if (state === "disabled") {
      return __objSpread(__objSpread({}, muted.disabled), {
        muted: {
